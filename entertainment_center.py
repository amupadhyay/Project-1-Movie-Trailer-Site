...
wonder_woman = media.Movie("Wonder Woman",
                     "The daughter of Zeus fights for justice and helps mankind overcome evil.",
                     "https://upload.wikimedia.org/wikipedia/en/e/ed/Wonder_Woman_%282017_film%29.jpg",
                     "https://www.youtube.com/watch?v=VSB4wGIdDwo")

# new instance of my favorite movie
lotr = media.Movie("Lord of the Rings",
                   "The adventure of conquering the inner & outer evil by the smallest of figures.",
...
o_brother_where_thou = media.Movie("O Brother Where Art Thou", "A group of guys hilarious discover more to life.",
                             "https://upload.wikimedia.org/wikipedia/en/5/5b/O_brother_where_art_thou_ver1.jpg",
                             "https://www.youtube.com/watch?v=eW9Xo2HtlJI")

superman = media.Movie("Man of Steel", "An alien comes to earth and saves the planet.",
                          "https://upload.wikimedia.org/wikipedia/en/8/85/ManofSteelFinalPoster.jpg",
                          "https://www.youtube.com/watch?v=T6DJcgm3wNY")

x_men = media.Movie("X-MEN Apocalypse", "A movies filled with racial and political undertones where Mutants save the world",
