...
lotr = media.Movie("Lord of the Rings",
                   "The conquering of inner & outer evil by the smallest of figures.",
...
x_men = media.Movie("X-MEN Apocalypse", "Mutants save the world",
